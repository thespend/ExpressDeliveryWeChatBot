...
# 生成聊天记录！
async def record_to_excel(group_dict, message_data: dict, express_name, mess_content, sort_name):
    """
    ...
    def _blocking_io():
        ...
        with FileLock(lock_file, timeout=10):
            ...
            if os.path.exists(filename):
                ...
                wb = Workbook()
                ws = wb.active
                headers = ['groupName', 'whoSend', 'ExpressName', 'messageContent', 'dateTime']
                ws.append(headers)
    ...
    try:
        ...
        print(f"Error during async excel writing: {e}")
        return 'failed'
